...
function App() {
  return (
    <main className='px-40 w-full pt-24'>
      <Navbar />

      <section
        id='home'
        className='min-h-[calc(100vh-6rem)] text-center flex flex-col justify-center'
      >
        <div className='mx-auto bg-gradient-to-b from-teal-500 rounded-full w-96 h-96 relative overflow-hidden mb-6 shadow-lg border-4 border-white'>
          <img src='/Foto de perfil Juan Sebastian.jpeg' className="object-cover w-full h-full" alt="profile" />
        </div>
        <h1 className='text-6xl font-medium mt-2'>Juan Sebastian Mesa</h1>
        <h3 className='text-4xl mt-1'>Law Student | Software Developer </h3>
        <p className='text-3xl py-1 text-gray-800'>Co-Founder of Rising</p>
        <div className='text-6xl py-2 flex justify-center gap-12 text-gray-600'>
        ...
        <div className='flex flex-col gap-4 mt-10'>
          <div className='w-full bg-black shadow-md rounded border-black cursor-pointer transform hover:-translate-y-2 hover:shadow-2xl active:scale-95 transition-all duration-200'>
            <a href="https://drive.google.com/drive/folders/11gbAZOe3SWwPq_Xo6NPvuW0S98p4Wv2Q?usp=drive_link">
              <div className='p-3'>
                <h1 className='text-3xl text-white font-medium text-center'>Download CV</h1>
              </div>
            </a>
          </div>
        </div>
